...
//SCL pin (P5_12)
#define SCL_MASK (1 << 12)
#define SCL_PORT R_PORT5
#define SCL_PFS PORT[5].PIN[12].PmnPFS

//SDA pin (P5_11)
#define SDA_MASK (1 << 11)
#define SDA_PORT R_PORT5
#define SDA_PFS PORT[5].PIN[11].PmnPFS
