...
const uint32_t sce_oem_key_size[SCE_OEM_CMD_NUM] =
{
    ...
    SCE_OEM_KEY_SIZE_ED25519_PUBLIC_KEY_INST_DATA_WORD,
    SCE_OEM_KEY_SIZE_ED25519_PRIVATE_KEY_INST_DATA_WORD,
    SCE_OEM_KEY_SIZE_HMAC_SHA384_INST_DATA_WORD,
    SCE_OEM_KEY_SIZE_HMAC_SHA512_INST_DATA_WORD,
    SCE_OEM_KEY_SIZE_HMAC_SHA512_224_INST_DATA_WORD,
    SCE_OEM_KEY_SIZE_HMAC_SHA512_256_INST_DATA_WORD,
};
...
fsp_err_t HW_SCE_EcdsaSignatureVerificationSubAdaptor(const uint32_t InData_CurveType[],
                                                  ...
                                                  const uint32_t InData_DomainParam[])
{
    return (HW_SCE_EcdsaSignatureVerificationSub(InData_CurveType, InData_Cmd, InData_KeyIndex, InData_MsgDgst, InData_Signature, InData_DomainParam));
}
