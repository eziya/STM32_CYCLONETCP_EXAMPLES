...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS                      (0x139FF) // 0 to 8, 11 to 13, 16
...
#define BSP_FEATURE_CGC_HAS_PLL2                             (1U) // On the RA4M2 there is another PLL that can be used as a clock source for USB.
...
#define BSP_FEATURE_DWT_CYCCNT                               (1U) // RA4M2 has Data Watchpoint Cycle Count Register
