...
#define BSP_FEATURE_BSP_HAS_USBCKDIVCR                       (1U) // On the RA4M3 there are specific registers for configuring the USB clock.
...
#define BSP_FEATURE_CGC_HAS_PLL2                             (1U) // On the RA4M3 there is another PLL that can be used as a clock source for USB.
#define BSP_FEATURE_CGC_HAS_SOPCCR                           (1U)
#define BSP_FEATURE_CGC_HAS_SOSC                             (1U)
#define BSP_FEATURE_CGC_HAS_SRAMPRCR2                        (1U) // On the RA4M3 there is another register to enable write access for SRAMWTSC.
...
#define BSP_FEATURE_DAC12_CHANNELS_PER_UNIT                  (2)
...
#define BSP_FEATURE_SDHI_MIN_CLOCK_DIVISION_SHIFT            (0U) // 0 (2^0) is minimum division supported
