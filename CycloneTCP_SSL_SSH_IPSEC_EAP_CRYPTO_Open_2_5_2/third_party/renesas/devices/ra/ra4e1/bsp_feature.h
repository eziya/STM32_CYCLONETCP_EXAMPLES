...
#define BSP_FEATURE_ADC_TSN_CALIBRATION32_AVAILABLE          (0U)      // Feature not available on this MCU
#define BSP_FEATURE_ADC_TSN_CALIBRATION32_MASK               (0U)      // Feature not available on this MCU
#define BSP_FEATURE_ADC_TSN_CALIBRATION_AVAILABLE            (0U)      // Feature not available on this MCU
#define BSP_FEATURE_ADC_TSN_CONTROL_AVAILABLE                (0U)      // Feature not available on this MCU
#define BSP_FEATURE_ADC_TSN_SLOPE                            (0)       // Feature not available on this MCU
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS                      (0x1381F) // 0 to 4, 11 to 13, 16
...
#define BSP_FEATURE_AGT_AGT_CHANNEL_COUNT                    (5)
...
#define BSP_FEATURE_CGC_HAS_PLL2                             (1U) // This MCU has an additional PLL that can be used as a clock source for USB.
#define BSP_FEATURE_CGC_HAS_SOPCCR                           (1U)
#define BSP_FEATURE_CGC_HAS_SOSC                             (1U)
#define BSP_FEATURE_CGC_HAS_SRAMPRCR2                        (1U) // This MCU has an additional register to enable write access for SRAMWTSC.
...
#define BSP_FEATURE_CGC_PLLCCR_VCO_MIN_HZ                    (0)
...
#define BSP_FEATURE_CGC_PLL_OUT_MIN_HZ                       (100000000U)
#define BSP_FEATURE_CGC_PLL_REFERENCE_CLK_MAX_HZ             (0)
#define BSP_FEATURE_CGC_PLL_REFERENCE_CLK_MIN_HZ             (0)
...
#define BSP_FEATURE_DAC12_CHANNELS_PER_UNIT                  (1)
#define BSP_FEATURE_DAC12_UNIT_COUNT                         (1)
...
#define BSP_FEATURE_DAC_B_CHANNELS_PER_UNIT                  (0)
#define BSP_FEATURE_DAC_B_UNIT_COUNT                         (0)
...
#define BSP_FEATURE_ETHER_MAX_QUEUE_NUM                      (0)  // Feature not available on this MCU
...
#define BSP_FEATURE_ICU_IRQ_CHANNELS_MASK                    (0x23FFU)
#define BSP_FEATURE_ICU_NMIER_MAX_INDEX                      (13U)            // Max used index in NMIER
#define BSP_FEATURE_ICU_SBYEDCR_MASK                         (0U)             // Feature not available on this MCU
#define BSP_FEATURE_ICU_WUPEN_MASK                           (0x7FB0D23FFULL) // Note there is another WUPEN1 register
...
#define BSP_FEATURE_LPM_DPSIEGR_MASK                         (0x1303F3U)
#define BSP_FEATURE_LPM_DPSIER_MASK                          (0x0D1F03F3U)
...
#define BSP_FEATURE_LPM_SBYCR_WRITE1_B14                     (1)
...
#define BSP_FEATURE_LVD_MONITOR_MASK                         (0x03U)                               // LVD mask monitor 1,2
...
#define BSP_FEATURE_POEG_HAS_POEGG_DERRST                    (0U)
...
#define BSP_FEATURE_SSI_FIFO_NUM_STAGES                      (0U) // Feature not available on this MCU
#define BSP_FEATURE_SSI_VALID_CHANNEL_MASK                   (0U) // Feature not available on this MCU
