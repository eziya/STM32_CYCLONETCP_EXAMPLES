...
#define BSP_FEATURE_BSP_MMF_SUPPORTED                        (1U) // Memory Mirror Function is supported
#define BSP_FEATURE_BSP_MPU_REGION0_MASK                     (0x00FFFFFFU)
#define BSP_FEATURE_BSP_MSTP_GPT_MSTPD5                      (1)
...
#define BSP_FEATURE_BSP_MSTP_POEG_MSTPD13                    (0)  // Feature not available on this MCU
...
#define BSP_FEATURE_ICU_NMIER_MAX_INDEX                      (12U) // Max used index in NMIER
...
#define BSP_FEATURE_USB_REG_PHYSLEW                          (1U)
#define BSP_FEATURE_USB_REG_PHYSLEW_VALUE                    (0xEU)
