 ...
 *
 * @retval SSP_SUCCESS                          The operation completed successfully.
 * @retval SSP_ERR_CRYPTO_SCE_RESOURCE_CONFLICT Resource conflict occurred.
 * @retval SSP_ERR_CRYPTO_SCE_FAIL              Internal I/O buffer is not empty.
 **********************************************************************************************************************/
ssp_err_t HW_SCE_RSA_2048PrivateKeyDecrypt (const uint32_t * InData_Text,
                                            ...
                                            uint32_t       * OutData_Text)
{
    ...
    if (RD1_MASK(REG_1BCH, 0x0000001f) != 0x0000000)
    {
        ...
        return SSP_ERR_CRYPTO_SCE_RESOURCE_CONFLICT;
    }
