 ...
 **    Texas Instruments TMS570LS1227ZWT
 **
...
#ifndef __IOTMS570LS1227ZWT_H
#define __IOTMS570LS1227ZWT_H
 ...
 ***************************************************************************
 **
 **    TMS570LS1227ZWT SPECIAL FUNCTION REGISTERS
 **
 ***************************************************************************
***************************************************************************/
...
/* ADC Group 1 Channel Selection Mode Control Register (ADG1CHNSELMODECTRL) */
typedef struct {
  __REG32 G1_ENH_CHNSEL_MODE_ENABLE : 4;
  __REG32                           :28;
} __adg1chnselmodectrl_bits;

/* ADC Group 2 Channel Selection Mode Control Register (ADG2CHNSELMODECTRL) */
typedef struct {
...
/* ADC Event Group Current Count Register (ADEVMAXCOUNT) */
typedef struct {
  __REG32 EV_MAX_COUNT              : 5;
  __REG32                           :27;
} __adevmaxcount_bits;

/* ADC Group 1 Current Count Register (ADG1CURRCOUNT) */
typedef struct {
  __REG32 G1_CURRENT_COUNT          : 5;
  __REG32                           :27;
} __adg1currcount_bits;

/* ADC Group 1 Current Count Register (ADG1MAXCOUNT) */
typedef struct {
  __REG32 G1_MAX_COUNT              : 5;
  __REG32                           :27;
} __adg1maxcount_bits;

/* ADC Group 2 Current Count Register (ADG2CURRCOUNT) */
typedef struct {
  __REG32 G2_CURRENT_COUNT          : 5;
  __REG32                           :27;
} __adg2currcount_bits;

/* ADC Group 2 Current Count Register (ADG2MAXCOUNT) */
typedef struct {
  __REG32 G2_MAX_COUNT              : 5;
  __REG32                           :27;
} __adg2maxcount_bits;
...
__IO_REG32_BIT(CLK2CNTRL,         0xFFFFE13C,__READ_WRITE ,__clk2cntrl_bits);
...
__IO_REG32_BIT(IOMM_PINMMR31,               0xFFFFEB8C,__READ_WRITE ,__iomm_pinmmr_bits);
__IO_REG32_BIT(IOMM_PINMMR32,               0xFFFFEB90,__READ_WRITE ,__iomm_pinmmr_bits);
__IO_REG32_BIT(IOMM_PINMMR33,               0xFFFFEB94,__READ_WRITE ,__iomm_pinmmr_bits);
__IO_REG32_BIT(IOMM_PINMMR34,               0xFFFFEB98,__READ_WRITE ,__iomm_pinmmr_bits);
...
__IO_REG32(    EMAC_DESC_BASE_ADDR,   0xFC520000,__READ_WRITE );
...
/***************************************************************************
 **
 **    TMS570LS1227ZWT INTERRUPT VALUES
 **
***************************************************************************/
/***************************************************************************
 **
...
#define VIM_EPWM1INT          90    /* ePMW 1 Interrupt */
#define VIM_EPWM1TZINT        91    /* ePWM 1 Trip Zone Interrupt */
#define VIM_EPWM2INT          92    /* ePWM 2 Interrupt */
#define VIM_EPWM2TZINT        93    /* ePWM 2 Trip Zone Interrupt */
#define VIM_EPWM3INT          94    /* ePWM 3 Interrupt */
#define VIM_EPWM3TZINT        95    /* ePWM 3 Trip Zone Interrupt */
#define VIM_EPWM4INT          96    /* ePWM 4 Interrupt */
#define VIM_EPWM4TZINT        97    /* ePWM 4 Trip Zone Interrupt */
#define VIM_EPWM5INT          98    /* ePWM 5 Interrupt */
#define VIM_EPWM5TZINT        99    /* ePWM 5 Trip Zone Interrupt */
#define VIM_EPWM6INT         100    /* ePWM 6 Interrupt */
#define VIM_EPWM6TZINT       101    /* ePWM 6 Trip Zone Interrupt */
#define VIM_EPWM7INT         102    /* ePWM 7 Interrupt */
#define VIM_EPWM7TZINT       103    /* ePWM 7 Trip Zone Interrupt */
#define VIM_ECAP1INT         104    /* eCAP 1 Interrupt */
#define VIM_ECAP2INT         105    /* eCAP 2 Interrupt */
#define VIM_ECAP3INT         106    /* eCAP 3 Interrupt */
#define VIM_ECAP4INT         107    /* eCAP 4 Interrupt */
#define VIM_ECAP5INT         108    /* eCAP 5 Interrupt */
#define VIM_ECAP6INT         109    /* eCAP 6 Interrupt */
#define VIM_EQEP1INT         110    /* eQEP 1 Interrupt */
#define VIM_EQEP2INT         111    /* eQEP 1 Interrupt */

#endif    /* __IOTMS570LS1227ZWT_H */
