...
static void init_chip_pins(void)
{
   ...
   PMC_REGS->PMC_PCER0 = (1 << CONF_WILC_RST_ID_PIO);
   PMC_REGS->PMC_PCER0 = (1 << CONF_WILC_CE_ID_PIO);
   PMC_REGS->PMC_PCER0 = (1 << CONF_WILC_WAKE_ID_PIO);
   PMC_REGS->PMC_PCER0 = (1 << CONF_WILC_CS_ID_PIO);
   PMC_REGS->PMC_PCER0 = (1 << CONF_WILC_IRQ_ID_PIO);
