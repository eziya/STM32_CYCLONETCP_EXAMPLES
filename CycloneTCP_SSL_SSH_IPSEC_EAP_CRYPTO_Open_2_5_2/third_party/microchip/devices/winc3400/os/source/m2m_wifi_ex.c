...
sint8 os_m2m_wifi_set_system_time(uint32 u32UTCSeconds)
{
   sint8 status;
   ...
   //Invoke underlying function
   status = m2m_wifi_set_system_time(u32UTCSeconds);
...
sint8 os_m2m_wifi_get_system_time(void)
{
   sint8 status;
   ...
   //Invoke underlying function
   status = m2m_wifi_get_system_time();
