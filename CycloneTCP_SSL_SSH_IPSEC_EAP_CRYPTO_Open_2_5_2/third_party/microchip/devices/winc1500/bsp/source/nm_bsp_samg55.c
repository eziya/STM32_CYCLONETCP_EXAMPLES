...
static void init_chip_pins(void)
{
   ...
   PMC_REGS->PMC_PCER0 = (1 << CONF_WINC_RST_ID_PIO);
   PMC_REGS->PMC_PCER0 = (1 << CONF_WINC_CE_ID_PIO);
   PMC_REGS->PMC_PCER0 = (1 << CONF_WINC_WAKE_ID_PIO);
   PMC_REGS->PMC_PCER0 = (1 << CONF_WINC_CS_ID_PIO);
   PMC_REGS->PMC_PCER0 = (1 << CONF_WINC_IRQ_ID_PIO);
