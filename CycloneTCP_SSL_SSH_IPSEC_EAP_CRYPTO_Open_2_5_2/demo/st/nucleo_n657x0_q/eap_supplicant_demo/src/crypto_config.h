...
#define STM32N6XX_CRYPTO_HASH_SUPPORT ENABLED
//Cipher hardware accelerator
#define STM32N6XX_CRYPTO_CIPHER_SUPPORT ENABLED
//Public-key hardware accelerator
#define STM32N6XX_CRYPTO_PKC_SUPPORT ENABLED
...
#define PKCS5_3DES_SUPPORT ENABLED
