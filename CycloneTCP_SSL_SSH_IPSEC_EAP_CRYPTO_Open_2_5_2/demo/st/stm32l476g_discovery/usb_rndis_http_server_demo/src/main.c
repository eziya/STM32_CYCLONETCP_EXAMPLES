...
#define APP_MAC_ADDR "00-00-00-00-04-76"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::476"
#define APP_IPV6_PREFIX "fd00:1:2:3::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "fd00:1:2:3::476"
...
void SystemClock_Config(void)
{
   ...
   RCC_OscInitStruct.HSI48State = RCC_LSE_ON;
   ...
   const char_t *param)
{
   ...
   {
      strcpy(connection->buffer, "STM32L476G-Discovery");
   }
