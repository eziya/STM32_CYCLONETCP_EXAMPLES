 ...
 *
 * The STM32MP13 implements 32 unique interrupt priorities.  For the purpose of
...
used. */
	 ...
	 * that is suitable for use on the STM32MP13 MPU.  FreeRTOS_Tick_Handler() must
...
Renesas RZ MPU. */
#define configINTERRUPT_CONTROLLER_BASE_ADDRESS	0xA0021000
