...
//LCD frame buffers
#define LCD_FRAME_BUFFER_LAYER0 0xD0530000
#define LCD_FRAME_BUFFER_LAYER1 0xD0400000

//USB/RNDIS interface configuration
#define APP_IF_NAME "usb0"
#define APP_HOST_NAME "http-server-demo"
#define APP_MAC_ADDR "00-00-00-00-04-29"
...
#define APP_IPV6_GLOBAL_ADDR "fd00:1:2:3::429"
...
void lcdPutChar(char_t c)
{
   ...
   else if(lcdLine < 13 && lcdColumn < 15)
   {
   ...
   const char_t *param)
{
   ...
   {
      strcpy(connection->buffer, "STM32F429I-Discovery");
   }
