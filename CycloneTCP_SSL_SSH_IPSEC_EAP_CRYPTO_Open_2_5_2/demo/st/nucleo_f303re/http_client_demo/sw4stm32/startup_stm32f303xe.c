...
const uint32_t vectorTable[101] =
{
   ...
   (uint32_t) EXTI2_TSC_IRQHandler,          //EXTI Line2 and Touch Sense controller
   ...
   (uint32_t) USB_HP_CAN_TX_IRQHandler,      //USB Device High Priority or CAN TX
   (uint32_t) USB_LP_CAN_RX0_IRQHandler,     //USB Device Low Priority or CAN RX0
   (uint32_t) CAN_RX1_IRQHandler,            //CAN RX1
   (uint32_t) CAN_SCE_IRQHandler,            //CAN SCE
   ...
   (uint32_t) ADC4_IRQHandler,               //ADC4
   (uint32_t) 0,                             //Reserved
   (uint32_t) 0,                             //Reserved
   (uint32_t) COMP1_2_3_IRQHandler,          //COMP1, COMP2 and COMP3
   (uint32_t) COMP4_5_6_IRQHandler,          //COMP4, COMP5 and COMP6
   (uint32_t) COMP7_IRQHandler,              //COMP7
   (uint32_t) 0,                             //Reserved
   (uint32_t) 0,                             //Reserved
   (uint32_t) 0,                             //Reserved
   (uint32_t) 0,                             //Reserved
   ...
   (uint32_t) USB_HP_IRQHandler,             //USB High Priority remap
   (uint32_t) USB_LP_IRQHandler,             //USB Low Priority remap
   (uint32_t) USBWakeUp_RMP_IRQHandler,      //USB Wakeup remap through EXTI
   (uint32_t) TIM20_BRK_IRQHandler,          //TIM20 Break
   (uint32_t) TIM20_UP_IRQHandler,           //TIM20 Update
   (uint32_t) TIM20_TRG_COM_IRQHandler,      //TIM20 Trigger and Commutation
   (uint32_t) TIM20_CC_IRQHandler,           //TIM20 Capture Compare
