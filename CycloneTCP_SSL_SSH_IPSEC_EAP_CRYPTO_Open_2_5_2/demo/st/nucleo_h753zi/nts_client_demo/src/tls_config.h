...
#define TLS_MIN_VERSION TLS_VERSION_1_3
...
//ML-KEM key exchange support (TLS 1.3)
#define TLS13_MLKEM_KE_SUPPORT DISABLED
//Hybrid key exchange support (TLS 1.3)
...
//PSK with ML-KEM key exchange support (TLS 1.3)
#define TLS13_PSK_MLKEM_KE_SUPPORT DISABLED
//PSK with hybrid key exchange support (TLS 1.3)
