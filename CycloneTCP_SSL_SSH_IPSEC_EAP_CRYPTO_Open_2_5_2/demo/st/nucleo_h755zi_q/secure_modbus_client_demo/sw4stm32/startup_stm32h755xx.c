...
const uint32_t vectorTable[166] =
{
   ...
   //Peripheral handlers
   (uint32_t) WWDG_IRQHandler,               //Window WatchDog interrupt ( wwdg1_it, wwdg2_it)
   ...
   (uint32_t) CM7_SEV_IRQHandler,            //CM7 Send event interrupt for CM4
   (uint32_t) CM4_SEV_IRQHandler,            //CM4 Send event interrupt for CM7
   (uint32_t) 0,                             //Reserved
   (uint32_t) 0,                             //Reserved
   ...
   (uint32_t) CRYP_IRQHandler,               //CRYP crypto
   ...
   (uint32_t) HSEM2_IRQHandler,              //HSEM2 global Interrupt
   ...
   (uint32_t) WWDG_RST_IRQHandler,           //Window Watchdog reset interrupt (exti_d2_wwdg_it, exti_d1_wwdg_it)
   ...
   (uint32_t) 0,                             //Reserved
   (uint32_t) HOLD_CORE_IRQHandler,          //Hold core interrupt
